...
*/
  ...
  if (($action == 'edit') && isset($HTTP_GET_VARS['oID'])) {
    ...
    $orders_query1 = tep_db_query("select * from " . TABLE_ORDERS . " where orders_id = '" . (int)$oID . "'");
    $order_exists = true;
      ...
      <tr>
        <td class="main"><table border="1" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <td class="smallText" align="center"><strong><?php echo 'Serial No.'; ?></strong></td>
            <td class="smallText" align="center"><strong><?php echo 'Issue No.'; ?></strong></td>
            <td class="smallText" align="center"><strong><?php echo 'Customer PO'; ?></strong></td>
          </tr>
<?php
$ordersM = tep_db_fetch_array($orders_query1);
    ...
    if (tep_db_num_rows($orders_history_query)) {
      while ($orders_history = tep_db_fetch_array($orders_history_query)) {
        ...
        echo '            <td class="smallText">' . $orders_status_array[$orders_history['orders_status_id']] . '</td>' . "\n" .
             ...
             '            <td class="smallText">' . nl2br(tep_db_output($ordersM['serial_no'])) . '&nbsp;</td>' . "\n" .
             '            <td class="smallText">' . nl2br(tep_db_output($ordersM['issue_no'])) . '&nbsp;</td>' . "\n" .
             '            <td class="smallText">' . nl2br(tep_db_output($ordersM['customer_po'])) . '&nbsp;</td>' . "\n" .
             '          </tr>' . "\n";
      }
    } else {
        echo '          <tr>' . "\n" .
...
<?php
    if (isset($HTTP_GET_VARS['cID'])) {
      ...
      $orders_query_raw = "select o.orders_id, o.customers_name, o.customers_id, o.payment_method, o.date_purchased, o.last_modified, o.currency, o.currency_value, s.orders_status_name, ot.text as order_total,o.issue_no,o.serial_no,o.customer_po from " . TABLE_ORDERS . " o left join " . TABLE_ORDERS_TOTAL . " ot on (o.orders_id = ot.orders_id), " . TABLE_ORDERS_STATUS . " s where o.customers_id = '" . (int)$cID . "' and o.orders_status = s.orders_status_id and s.language_id = '" . (int)$languages_id . "' and ot.class = 'ot_total' order by orders_id DESC";
    } elseif (isset($HTTP_GET_VARS['status']) && is_numeric($HTTP_GET_VARS['status']) && ($HTTP_GET_VARS['status'] > 0)) {
      $status = tep_db_prepare_input($HTTP_GET_VARS['status']);
      $orders_query_raw = "select o.orders_id, o.customers_name, o.payment_method, o.date_purchased, o.last_modified, o.currency, o.currency_value, s.orders_status_name, ot.text as order_total,o.issue_no,o.serial_no,o.customer_po from " . TABLE_ORDERS . " o left join " . TABLE_ORDERS_TOTAL . " ot on (o.orders_id = ot.orders_id), " . TABLE_ORDERS_STATUS . " s where o.orders_status = s.orders_status_id and s.language_id = '" . (int)$languages_id . "' and s.orders_status_id = '" . (int)$status . "' and ot.class = 'ot_total' order by o.orders_id DESC";
    } else {
...
?>
                ...
                <td class="dataTableContent" align="center"><?php $date = date_create($orders['date_purchased']);
				
				 echo date_format($date, 'd/m/Y g:i A'); ?></td>
  ...
  switch ($action) {
    ...
    default:
      if (isset($oInfo) && is_object($oInfo)) {
        ...
        $contents[] = array('text' => '<br />Serial No. '  . $oInfo->serial_no);
        $contents[] = array('text' => '<br />Issue No. '  . $oInfo->issue_no);
        $contents[] = array('text' => '<br />Customer PO '  . $oInfo->customer_po);
      }
      break;
  }
