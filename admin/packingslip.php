    ...
    <td><table border="0" cellspacing="0" cellpadding="2">
      <tr>
        ...
        <td class="main"><?php echo $order->info['payment_method']; ?></td>
           ...
           <tr>
              <td class="main"><strong><?php echo 'Serial No.'; ?></strong></td>
              <td class="main"><?php echo $order->info['serial_no']; ?></td>
            </tr>
            <tr>
              <td class="main"><strong><?php echo 'Issue No.'; ?></strong></td>
              <td class="main"><?php echo $order->info['issue_no']; ?></td>
            </tr>
            <tr>
              <td class="main"><strong><?php echo 'Customer PO'; ?></strong></td>
              <td class="main"><?php echo $order->info['customer_po']; ?></td>
            </tr>
    </table></td>
  </tr>
  <tr>
