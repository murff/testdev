  ...
  if (tep_not_null($action)) {
    switch ($action) {
      case 'update':
		...
		$customers_grioup_id = tep_db_prepare_input($HTTP_POST_VARS['cgroup']);
        $staplesadmin = tep_db_prepare_input($HTTP_POST_VARS['staplesadmin']);
		$customers_username = tep_db_prepare_input($HTTP_POST_VARS['customers_username']);
         $customers_password = tep_db_prepare_input($HTTP_POST_VARS['customers_password']);
      ...
      if ($error == false) {
        ...
        $sql_data_array = array('customers_firstname' => $customers_firstname,
								...
								'staples_admin' => $staplesadmin,
								'customer_group_id' =>	$customers_grioup_id);
		...
		if(isset($customers_password) && $customers_password!='') {
		$sql_data_array2 = array('customers_password' => md5($customers_password));
		tep_db_perform(TABLE_CUSTOMERS, $sql_data_array2, 'update', "customers_id = '" . (int)$customers_id . "'");	
		}
      ...
      case 'deleteconfirm':
        ...
        break;
      default:
        $customers_query = tep_db_query("select c.customers_id, c.customers_gender, c.customers_username, c.customers_password, c.customers_firstname, c.customers_lastname, c.customers_dob, c.customers_email_address, c.customer_group_id, c.staples_admin, a.entry_company, a.entry_street_address, a.entry_suburb, a.entry_postcode, a.entry_city, a.entry_state, a.entry_zone_id, a.entry_country_id, c.customers_telephone, c.customers_fax, c.customers_newsletter, c.customers_default_address_id from " . TABLE_CUSTOMERS . " c left join " . TABLE_ADDRESS_BOOK . " a on c.customers_default_address_id = a.address_book_id where a.customers_id = c.customers_id and c.customers_id = '" . (int)$HTTP_GET_VARS['cID'] . "'");
...
?></td>
   ...
   <tr>
    <td class="formAreaTitle"><br><?php echo 'Login information'; ?></td>
  </tr>
  <tr>
    <td class="main"><table border="0" width="100%" cellspacing="0" cellpadding="2" class="formArea">
      <tr>
        <td class="main"><table border="0" cellspacing="0" cellpadding="2">
          <tr>
               <td class="main">&nbsp;<?php echo 'User name'; ?></td>
               <td class="main">&nbsp;
<?php echo tep_draw_input_field('customers_username', $cInfo->customers_username,'autocomplete="off" required','true'); ?></td>
          </tr>
            <tr>
               <td class="main">&nbsp;<?php echo 'Password'; ?></td>
               <td class="main">&nbsp;
<input type="text" name="customers_password" id="customers_password" maxlength="40"   autocomplete="off" ><br /><span style="font-weight:bold">Leave the password field empty if you donot want to change password<br />
</span></td>
          </tr>
       ...
       <tr>
    <td class="formAreaTitle"><br><?php echo 'Cutomer Group'; ?></td>
  </tr>
  <tr>
    <td class="main"><table border="0" width="100%" cellspacing="0" cellpadding="2" class="formArea">
      <tr>
        <td class="main"><table border="0" cellspacing="0" cellpadding="2">
          <tr>
               <td class="main">&nbsp;<?php echo 'Cutomer Group'; ?></td>
               <td class="main">&nbsp;
<select name="cgroup" id="cgroup" onchange="showstaples(this.value)">
<option>Please Select Customer Group</option>
<?php
      $customers_groups = tep_db_query("select * from customers_groups");
	  
	  while($row=tep_db_fetch_array($customers_groups)){ ?>
      	
        <option value="<?php echo $row['customers_group_id']; ?>" <?php if($cInfo->customer_group_id==$row['customers_group_id']){ ?> selected="selected"<?php } ?>><?php echo $row['customers_group_name']; ?></option>
...
<?php } ?>
  ...
  <tr <?php if($cInfo->customer_group_id!=3) { ?> class="staples" <?php } ?>>
    <td class="formAreaTitle"><br><?php echo 'Assign Staples admin'; ?></td>
  </tr>
  <tr <?php if($cInfo->customer_group_id!=3) { ?> class="staples" <?php } ?>>
    <td class="main"><table border="0" width="100%" cellspacing="0" cellpadding="2" class="formArea">
      <tr>
        <td class="main"><table border="0" cellspacing="0" cellpadding="2">
          <tr>
               <td class="main">&nbsp;<?php echo 'Staples admin/Parts order specialist'; ?></td>
               <td class="main">&nbsp;
<select name="staplesadmin" id="staplesadmin">
<option>Please Select Staple admin</option>
<?php
      $staples_admin = tep_db_query("select * from customers where customer_group_id = 2");
	  //print_r($customers_groups);
	  //exit;
	  
	  while($row=tep_db_fetch_array($staples_admin)){ ?>
      	
        <option value="<?php echo $row['customers_id']; ?>" <?php if($cInfo->staples_admin==$row['customers_id']){ ?> selected="selected"<?php } ?>><?php echo $row['customers_firstname'].' '.$row['customers_lastname']; ?></option>
          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                ...
                <td class="dataTableHeadingContent"><?php echo 'Customer Group'; ?></td>
...
<?php
    ...
    $customers_query_raw = "select c.customers_id, c.customers_lastname, c.customer_group_id, c.customers_firstname, c.customers_email_address, a.entry_country_id from " . TABLE_CUSTOMERS . " c left join " . TABLE_ADDRESS_BOOK . " a on c.customers_id = a.customers_id and c.customers_default_address_id = a.address_book_id " . $search . " order by c.customers_lastname, c.customers_firstname";
...
?>
                ...
                <td class="dataTableContent"><?php echo $customers['customers_firstname']; ?></td>
                 <td class="dataTableContent"><?php echo get_customer_group($customers['customer_group_id']); ?></td>
...
?>
<script>
window.opener.document.forms[0].password.value='';
