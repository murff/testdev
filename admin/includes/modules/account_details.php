...
/*$customerGroup_array = array(array('id' => '1',
                                  'text' => ENTRY_NEWSLETTER_YES),
                            array('id' => '0',
                                  'text' => ENTRY_NEWSLETTER_NO));
*/
      ...
      <tr>
        <td class="main"><table border="0" cellspacing="0" cellpadding="2">
          <tr>
               ...
               <td class="main">&nbsp;
<?php echo tep_draw_input_field('customers_username', '','autocomplete="off" id="customers_username" required','true'); ?></td>
          </tr>
            <tr>
               <td class="main">&nbsp;<?php echo 'Password'; ?></td>
               <td class="main">&nbsp;
<input type="password" name="customers_password" id="customers_password" maxlength="40" autocomplete="off" required>&nbsp;<span class="fieldRequired">* Required</span></td>
          </tr>
...
<?php
	  ...
	  while($row=tep_db_fetch_array($customers_groups)){ ?>
        ...
        <option value="<?php echo $row['customers_group_id']; ?>"><?php echo $row['customers_group_name']; ?></option>
...
<?php
	  ...
	  while($row=tep_db_fetch_array($staples_admin)){ ?>
        ...
        <option value="<?php echo $row['customers_id']; ?>"><?php echo $row['customers_firstname'].' '.$row['customers_lastname']; ?></option>
