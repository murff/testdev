<?php
/*
   for Separate Pricing Per Customer v4.2.3 2013/09/30
*/
  
define('HEADING_TITLE_DEFAULT', 'Groups');
define('HEADING_TITLE_EDIT_GROUP', 'Edit Group Settings');
define('HEADING_TITLE_ADD_NEW_GROUP', 'Add New Group');
...
define('ENTRY_PAYMENT_SET_EXPLAIN', 'If you choose <strong>[Set payment modules for the customer group]</strong> but do not check any of the boxes, default settings will still be used.');
...
define('ENTRY_SHIPPING_SET_EXPLAIN', 'If you choose <strong>[Set shipping modules for the customer group]</strong> but do not check any of the boxes, default settings will still be used.');
...
define('ENTRY_ORDER_TOTAL_SET_EXPLAIN', 'If you choose <strong>[Set order total modules for the customer group]</strong> but do not check any of the boxes, default settings will still be used.');

define('TEXT_DELETE_INTRO', 'Are you sure you want to delete this group?');
define('TEXT_NO_DELETE_GROUP', 'You may not delete this group');
...
define('ENTRY_TAX_RATES_EXEMPT_EXPLAIN', 'If you choose <strong>[Exempt tax rates from the customer group]</strong> but do not check any of the boxes, default settings (zone based) will still be used.<br />If you have set this group to Tax Exempt "Yes" above, none of these settings will have any effect.');
?>