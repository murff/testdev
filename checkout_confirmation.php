...
// if no shipping method has been selected, redirect the customer to the shipping method selection page
  ...
  if (!tep_session_is_registered('serial_no')) tep_session_register('serial_no');
  if (isset($HTTP_POST_VARS['serial_no']) && tep_not_null($HTTP_POST_VARS['serial_no'])) {
    $serial_no = tep_db_prepare_input($HTTP_POST_VARS['serial_no']);
  }
  
  if (!tep_session_is_registered('issue_no')) tep_session_register('issue_no');
  if (isset($HTTP_POST_VARS['issue_no']) && tep_not_null($HTTP_POST_VARS['issue_no'])) {
    $issue_no = tep_db_prepare_input($HTTP_POST_VARS['issue_no']);
  }

  if (!tep_session_is_registered('customer_po')) tep_session_register('customer_po');
  if (isset($HTTP_POST_VARS['customer_po']) && tep_not_null($HTTP_POST_VARS['customer_po'])) {
    $customer_po = tep_db_prepare_input($HTTP_POST_VARS['customer_po']);
  }
...
<?php
  ...
  <h2><?php echo '<strong>Serial Number</strong> <a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></h2>
  
  <div class="contentText">
    <?php echo nl2br($serial_no) . tep_draw_hidden_field('serial_no', $order->info['serial_no']); ?>
  </div>
...
<?php  
 ...
 <?php
  ...
  <h2><?php echo '<strong>Issue Number</strong> <a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></h2>
  
  <div class="contentText">
    <?php echo nl2br($issue_no) . tep_draw_hidden_field('issue_no', $order->info['issue_no']); ?>
  </div>
...
<?php  
 ...
 ?>
  ...
  if (isset($customer_po)) {
  ?>
	
  <h2><?php echo '<strong>Customer PO</strong> <a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></h2>
  
  <div class="contentText">
    <?php echo nl2br($customer_po) . tep_draw_hidden_field('customer_po', $order->info['customer_po']); ?>
  </div>
