...
?>
  ...
  <h2>Serial Number</h2>
	<div class="contentText">
			<?php echo tep_draw_input_field('serial_no',  $serial_no); ?>
	</div>
  
  <h2>Issue Number</h2>
	<div class="contentText">
			<?php echo tep_draw_input_field('issue_no',  $issue_no); ?>
	</div>
  
  <h2>Customer PO Number</h2>
	<div class="contentText">
			<?php echo tep_draw_input_field('customer_po',  $customer_po); ?>
	</div>
