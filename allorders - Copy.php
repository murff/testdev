  ...
  function get_order($id = ''){
	...
	$status = isset($_GET['status']) && $_GET['status']=='n'?'s':'n';
	  ...
	  $my_table_head='<table width="100%" cellspacing="0" cellpadding="10" border="0">
              <thead><tr >
			  <th data-sort="Date"><a href="allorders.php?date_added='.$date_added.'"><span>Date</span><span class = "ui-icon-triangle-1-'.$_GET['date_added'].'" style="float:right;"></span></a></th>
			   <th><a href="allorders.php?po_no='.$po_no.'"><span>PO#</span><span class = "ui-icon-triangle-1-'.$_GET['po_no'].'" style="float:right;"></span></a></th>
               <th ><a href="allorders.php?customer_id='.$customer_id.'"><span>Name</span><span class = "ui-icon-triangle-1-'.$_GET['customer_id'].'" style="float:right;"></span></a></th>
                <th><a href="allorders.php?group_name='.$group_name.'"><span>Group</span><span class = "ui-icon-triangle-1-'.$_GET['group_name'].'" style="float:right;"></span></a></th>
                 <th><a href="allorders.php?serial='.$serial.'"><span>Serial#</span><span class = "ui-icon-triangle-1-'.$_GET['serial'].'" style="float:right;"></span></a></th>
		<th><a href="allorders.php?issue_no='.$issue_no.'"><span>Issue#</span><span class = "ui-icon-triangle-1-'.$_GET['issue_no'].'" style="float:right;"></span></a></th>
				  
				    
                  <th>View Detail</th>
				  <th><a href="allorders.php?order_quote='.$order_quote.'"><span>Request Type</span><span class = "ui-icon-triangle-1-'.$_GET['order_quote'].'" style="float:right;"></span></a></th>
                   <th><a href="allorders.php?status='.$status.'"><span>Status</span><span class = "ui-icon-triangle-1-'.$_GET['status'].'" style="float:right;"></span></a></th>
              </tr></thead>
    <tbody>';
			  $where='';
	  if($id!=''){
