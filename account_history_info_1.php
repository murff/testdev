    ...
    <table border="0" width="100%" cellspacing="1" cellpadding="2">
      <tr>
        <td width="30%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td><strong><?php echo 'Serial No.'; ?></strong></td>
          </tr>
          <tr>
            <td><?php echo $order->info['serial_no']; ?></td>
          </tr>
          <tr>
            <td><strong><?php echo 'Issue No.'; ?></strong></td>
          </tr>
          <tr>
            <td><?php echo $order->info['issue_no']; ?></td>
          </tr>
          <tr>
            <td><strong><?php echo 'Customer PO'; ?></strong></td>
          </tr>
          <tr>
            <td><?php echo $order->info['customer_po']; ?></td>
          </tr>
        </table></td>
