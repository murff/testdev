...
// if no shipping method has been selected, redirect the customer to the shipping method selection page
  ...
  if (!tep_session_is_registered('costumer_po')) tep_session_register('costomer_po');
  if (isset($HTTP_POST_VARS['comments']) && tep_not_null($HTTP_POST_VARS['customer_po'])) {
    $comments = tep_db_prepare_input($HTTP_POST_VARS['customer_po']);
