...
*/
  ...
  class order {
    ...
    function query($order_id) {
      ...
      $order_query = tep_db_query("select customers_id, customers_name, customers_company, customers_street_address, customers_suburb, customers_city, customers_postcode, customers_state, customers_country, customers_telephone, customers_email_address, customers_address_format_id, delivery_name, delivery_company, delivery_street_address, delivery_suburb, delivery_city, delivery_postcode, delivery_state, delivery_country, delivery_address_format_id, billing_name, billing_company, billing_street_address, billing_suburb, billing_city, billing_postcode, billing_state, billing_country, billing_address_format_id, payment_method, cc_type, cc_owner, cc_number, cc_expires, currency, currency_value, date_purchased, orders_status, last_modified,issue_no,serial_no,customer_po from " . TABLE_ORDERS . " where orders_id = '" . (int)$order_id . "'");
      ...
      $this->info = array('currency' => $order['currency'],
             		 ...
             		 'serial_no' => strip_tags($order['serial_no']),
                          'issue_no' => strip_tags($order['issue_no']),
                          'customer_po' => strip_tags($order['customer_po']),			  
    ...
    function cart() {
      global $HTTP_POST_VARS, $customer_id, $sendto, $billto, $cart, $languages_id, $currency, $currencies, $shipping, $payment, $comments, $serial_no, $issue_no, $customer_po, $customer_default_address_id;
      ...
      $this->info = array('order_status' => DEFAULT_ORDERS_STATUS_ID,
                          ...
                          'tax' => 0,
                          'tax_groups' => array(),						  
			  'serial_no' => (tep_session_is_registered('serial_no') && !empty($serial_no) ? $serial_no : ''),
			  'issue_no' => (tep_session_is_registered('issue_no') && !empty($issue_no) ? $issue_no : ''),
		'customer_po' => (tep_session_is_registered('customer_po') && !empty($customer_po) ? $customer_po : ''),                        'comments' => (tep_session_is_registered('comments') && !empty($comments) ? $comments : ''));						  
