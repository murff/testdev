...
// process the selected shipping method
  ...
  if ( isset($HTTP_POST_VARS['action']) && ($HTTP_POST_VARS['action'] == 'process') && isset($HTTP_POST_VARS['formid']) && ($HTTP_POST_VARS['formid'] == $sessiontoken) ) {
    ...
    if (tep_not_null($HTTP_POST_VARS['serial_no'])) {
    ...
    if (tep_not_null($HTTP_POST_VARS['issue_no'])) {
    ...
    if (tep_not_null($HTTP_POST_VARS['customer_po'])) {
...
?>
	...
	<h2>Serial Number</h2>
	<div class="contentText">
			<?php echo tep_draw_input_field('serial_no', ''); ?>
	</div>
	
	<h2>Issue Number</h2>
	<div class="contentText">
			<?php echo tep_draw_input_field('issue_no', ''); ?>
	</div>
	
	<h2>PO Number</h2>
	<div class="contentText">
			<?php echo tep_draw_input_field('customer_po', ''); ?>
	</div>
