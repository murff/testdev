...
// load the before_process function from the payment modules
  ...
  $sql_data_array = array('customers_id' => $customer_id,
                          ...
                          'customer_po' => $order->info['customer_po'], 
                          'serial_no' => $order->info['serial_no'], 
                          'issue_no' => $order->info['issue_no'], 
...
// lets start with the email confirmation
  ...
  if ($order->info['serial_no']) {
    $email_order .= "Serial Number\n".tep_db_output($order->info['serial_no']) . "\n\n";
  }
  if ($order->info['issue_no']) {
    $email_order .= "Issue Number\n".tep_db_output($order->info['issue_no']) . "\n\n";
  }
    if ($order->info['customer_po']) {
      $email_order .= "Customer PO\n".tep_db_output($order->info['customer_po']) . "\n\n";
    }
...
// unregister session variables used during checkout
  ...
  tep_session_unregister('serial_no');
  tep_session_unregister('issue_no');
  tep_session_unregister('customer_po');
